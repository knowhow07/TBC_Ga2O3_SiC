...
path = "<PATH_TO_DATA>/vasp_jobs/nep_0217/emd/SiC/rotate/750k"      # folders to search
...
USE_PLATEAU = False        # True: auto-plateau from kiso_avg(t); False: use last LAST_WINDOW_PS
