...
# ---- user knobs ----
skip_fraction    = 0.8     # use last 50% of rows as steady state
time_step_fs     = 1.0     # GPUMD time_step
sample_interval  = 200     # from "compute 0 200 100 temperature"
output_interval  = 100
# fitting windows for each material (Å) – ADJUST
x_sic_min, x_sic_max = 20.0, 50.0
x_ga_min, x_ga_max   = 60.0, 90.0

x_int = 110.0        # interface position (Å), adjust from structure
# --------------------
