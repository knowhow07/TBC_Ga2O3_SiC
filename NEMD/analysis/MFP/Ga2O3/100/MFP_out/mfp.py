...
MODEL_FILE = "<PATH_TO_DATA>/qe_jobs/nep_training/NEMD/0217/post/MFP/Ga2O3/100/shortbar/job_01/model.xyz"
SHC_GROUP_ID = 3
...
valid = (
    ...
    np.isfinite(G_use) &
    (G_use > 0.0) &
    (G_use > 3.0 * G_err_use)   # or 2x, 5x depending on how strict you want
)
