...
# USER KNOBS
# =========================
PATH_ROOT   = "<PATH_TO_DATA>/qe_jobs/nep_training/NEMD/0217/post/MFP/Ga2O3/201/shortbar"
...
def main():
   ...
   #-- Save cumulative integrals data (plotting only) ----
    ...
    plt.xlim(0, 35)
    # plt.title(f"Bulk Ga2O3 short-bar spectral conductance (paper unit, group {SHC_GROUP_ID})")
    plt.title(r"Bulk Ga$_2$O$_3$ (-201) short-bar spectral conductance", fontsize=20)
    plt.grid(True, linestyle="--", alpha=0.35)
    plt.legend()
    plt.tight_layout()
