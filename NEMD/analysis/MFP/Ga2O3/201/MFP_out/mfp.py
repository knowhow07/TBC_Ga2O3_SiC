...
# USER SETTINGS
# =========================
KAPPA_FILE = "<PATH_TO_DATA>/qe_jobs/nep_training/NEMD/0217/post/MFP/Ga2O3/201/hnemd/kappa_spectrum_avg_with_error.txt"
# G_FILE     = "<PATH_TO_DATA>/qe_jobs/nep_training/NEMD/0217/post/210-300k/pure/Ga2O3/bulk_ga2o3_shortbar_Gomega_avg.txt"
G_FILE     = "<PATH_TO_DATA>/qe_jobs/nep_training/NEMD/0217/post/MFP/Ga2O3/201/shortbar/bulk_ga2o3_shortbar_Gomega_avg_native.txt"

OUT_PREFIX = "mfp_from_kappa_over_G_native"

# --- geometry source for SHC-region length ---
MODEL_FILE = "<PATH_TO_DATA>/qe_jobs/nep_training/NEMD/0217/post/210-300k/pure/Ga2O3/job_01/model.xyz"
SHC_GROUP_ID = 3
...
# new revision based on native G
# native G file unit:
# eV ps^-1 THz^-1 Å^-2 K^-1
# convert to SI:
# 1 eV / (ps * Å^2) = 1.602176634e13 W / m^2
G_CONV_TO_SI = EV_PER_PS_A2_TO_W_M2
...
print(f"Saved: {OUT_PREFIX}_linear.png")
print("\nNOTE:")
