...
# ============================================================
font_size = 24
FS_LAYER   = 26   # layer titles
FS_NODE    = 26   # labels inside nodes
...
# ============================================================
SAVE_FIG = True
OUT_PNG = "nep_nn_structure_revised.png"
OUT_PDF = "nep_nn_structure_revised.pdf"
...
for yi in y_in:
    for yh in y_hid:
        ax.plot([x_in + r_in, x_hid - r_hid], [yi, yh],
                color=C_EDGE, lw=1.0, alpha=0.75, zorder=1)

for yh in y_hid:
    ax.plot([x_hid + r_hid, x_out - r_out], [yh, y_out],
            color=C_EDGE, lw=1.1, alpha=0.8, zorder=1)
...
# ============================================================
for y in y_in:
    ax.add_patch(Circle((x_in, y), r_in, facecolor=C_IN, edgecolor="black", lw=0.9, zorder=3))

for y in y_hid:
    ax.add_patch(Circle((x_hid, y), r_hid, facecolor=C_HID, edgecolor="black", lw=0.9, zorder=3))

ax.add_patch(Circle((x_out, y_out), r_out, facecolor=C_OUT, edgecolor="black", lw=0.9, zorder=3))
